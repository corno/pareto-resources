...
import * as t_signatures from "../../../../../../interface/generated/liana/schemas/fs_unrestricted_stat_possible_node/signatures/refiners/astn_parse_tree"

import * as t_out from "../../../../../../interface/generated/liana/schemas/fs_unrestricted_stat_possible_node/data"
                                ...
                                switch ($t) {
                                    case 'unknown':
                                        return p_change_context(
                                            $['value'],
                                            ($) => ['unknown', v_unmarshalled_from_parse_tree.Nothing(
                                                $,
                                                ($) => abort(
                                                    $,
                                                ),
        ...
        ($, $t):t_out.Node_Type => {
            switch ($t) {
                case 'does not exist':
                    return p_change_context(
                        $['value'],
                        ($) => ['does not exist', v_unmarshalled_from_parse_tree.Nothing(
                            $,
                            ($) => abort(
                                $,
                            ),
