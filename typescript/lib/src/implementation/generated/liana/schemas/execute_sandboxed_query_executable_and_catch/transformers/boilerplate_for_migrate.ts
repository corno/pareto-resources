...
import * as t_signatures from "../../../../../../interface/generated/liana/schemas/execute_sandboxed_query_executable_and_catch/signatures/transformers/boilerplate_for_migrate.js"
...
export const Result: t_signatures.Result = ($) => p_decide_state(
    $,
    ($): t_out.Result => {
        switch ($[0]) {
            case 'success':
