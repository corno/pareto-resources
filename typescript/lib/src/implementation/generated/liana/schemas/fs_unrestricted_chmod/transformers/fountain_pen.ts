...
import * as t_signatures from "../../../../../../interface/generated/liana/schemas/fs_unrestricted_chmod/signatures/transformers/fountain_pen.js"
...
export const Permissions: t_signatures.Permissions = ($) => v_serialize.Document(
    v_marshall.Permissions(
        $,
    ),
)
