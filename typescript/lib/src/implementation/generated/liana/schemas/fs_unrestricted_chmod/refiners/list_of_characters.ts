...
import * as t_signatures from "../../../../../../interface/generated/liana/schemas/fs_unrestricted_chmod/signatures/refiners/list_of_characters.js"
...
export const Permissions: t_signatures.Permissions = ($, abort, $p) => v_unmarshall.Permissions(
    v_deserialize.Document(
        $,
        ($) => abort(
            ['parse error', $],
