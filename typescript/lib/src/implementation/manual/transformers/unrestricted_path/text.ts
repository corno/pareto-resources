...
export const Node_Path: p_i.Transformer<d_in.Node_Path, d_out.Text> = ($) => p_text_from_list(
    t_to_loc.Node_Path($),
     ($) => $
    )

export const Context_Path: p_i.Transformer<d_in.Context_Path, d_out.Text> = ($) => p_text_from_list(
