...
export namespace commands {
    ...
    export type command_executable = _pci.Command_Procedure<
    ...
    export type smelly_command_executable = _pci.Command_Procedure<
...
export namespace queries {
    ...
    export type query_executable = _pqi.Query_Function<
